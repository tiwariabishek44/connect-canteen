...
import 'package:connect_canteen/app/modules/user_module/orders/view/hold_page.dart';
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      if (orderController.isLoading.value) {
        ...
        log("this is the value ${orderController.orderLoded.value}");
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              orderController.orderResponse.value
                                          ...
                                          '' ||
                                      orderController.orderResponse.value
                                          .response![index].holdDate.isNotEmpty
                                  ? Container(
                                      decoration: BoxDecoration(
                    ...
                    if (orderController
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          ...
                          child: CircleAvatar(
                              radius: 17.sp,
                              backgroundImage: AssetImage('assets/hold.jpeg')),
                        ),
                      ),
                  ],
                ),
