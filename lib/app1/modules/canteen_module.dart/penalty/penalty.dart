...
import 'package:connect_canteen/app1/modules/canteen_module.dart/penalty/penalty_controller.dart';
...
class PenaltyPage extends StatelessWidget {
  ...
  final penaltyController = Get.put(PenaltyController());
  @override
    ...
    return Stack(
      children: [
        ...
        Positioned(
          top: 50.h,
          left: 40.w,
          child: Obx(() => penaltyController.penaltyChargeLoading.value
              ? LoadingWidget()
              : SizedBox.shrink()),
        )
      ],
